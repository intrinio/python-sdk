...
[**View Intrinio API Documentation**](https://docs.intrinio.com/documentation/python/get_crypto_book_asks_v2)
...
[**View Intrinio API Documentation**](https://docs.intrinio.com/documentation/python/get_crypto_book_bids_v2)
...
[**View Intrinio API Documentation**](https://docs.intrinio.com/documentation/python/get_crypto_book_summary_v2)
...
[**View Intrinio API Documentation**](https://docs.intrinio.com/documentation/python/get_crypto_currencies_v2)
...
[**View Intrinio API Documentation**](https://docs.intrinio.com/documentation/python/get_crypto_exchanges_v2)
...
[**View Intrinio API Documentation**](https://docs.intrinio.com/documentation/python/get_crypto_pairs_v2)
...
try:
  api_response = crypto_api.get_crypto_price_technicals_mfi(pair=pair, exchange=exchange, currency=currency, period=period, timeframe=timeframe, timezone=timezone, start_date=start_date, start_time=start_time, end_date=end_date, end_time=end_time, page_size=page_size, next_page=next_page)
  pprint(api_response)
except ApiException as e:
  print("Exception when calling CryptoApi->get_crypto_price_technicals_mfi: %s\n" % e)
...
try:
  api_response = crypto_api.get_crypto_price_technicals_mi(pair=pair, exchange=exchange, currency=currency, ema_period=ema_period, sum_period=sum_period, timeframe=timeframe, timezone=timezone, start_date=start_date, start_time=start_time, end_date=end_date, end_time=end_time, page_size=page_size, next_page=next_page)
  pprint(api_response)
except ApiException as e:
  print("Exception when calling CryptoApi->get_crypto_price_technicals_mi: %s\n" % e)
...
try:
  api_response = crypto_api.get_crypto_price_technicals_nvi(pair=pair, exchange=exchange, currency=currency, timeframe=timeframe, timezone=timezone, start_date=start_date, start_time=start_time, end_date=end_date, end_time=end_time, page_size=page_size, next_page=next_page)
  pprint(api_response)
except ApiException as e:
  print("Exception when calling CryptoApi->get_crypto_price_technicals_nvi: %s\n" % e)
...
try:
  api_response = crypto_api.get_crypto_price_technicals_obv(pair=pair, exchange=exchange, currency=currency, timeframe=timeframe, timezone=timezone, start_date=start_date, start_time=start_time, end_date=end_date, end_time=end_time, page_size=page_size, next_page=next_page)
  pprint(api_response)
except ApiException as e:
  print("Exception when calling CryptoApi->get_crypto_price_technicals_obv: %s\n" % e)
...
try:
  api_response = crypto_api.get_crypto_price_technicals_obv_mean(pair=pair, exchange=exchange, currency=currency, period=period, timeframe=timeframe, timezone=timezone, start_date=start_date, start_time=start_time, end_date=end_date, end_time=end_time, page_size=page_size, next_page=next_page)
  pprint(api_response)
except ApiException as e:
  print("Exception when calling CryptoApi->get_crypto_price_technicals_obv_mean: %s\n" % e)
...
price_key = 'close' # str | The Crypto Currency Price field to use when calculating Relative Strength Index. (optional) (default to close)
timeframe = 'd1' # str | The time interval for the prices when calculating technicals. (optional) (default to d1)
timezone = 'UTC' # str | Return technical date/times in this timezone, also interpret start/end date/time parameters in this timezone. (optional) (default to UTC)
start_date = '' # date | Return technicals on or after this date. (optional)
start_time = '' # str | Return technicals at or after this time (24-hour). (optional)
...
try:
  api_response = crypto_api.get_crypto_price_technicals_rsi(pair=pair, exchange=exchange, currency=currency, period=period, price_key=price_key, timeframe=timeframe, timezone=timezone, start_date=start_date, start_time=start_time, end_date=end_date, end_time=end_time, page_size=page_size, next_page=next_page)
  pprint(api_response)
except ApiException as e:
  print("Exception when calling CryptoApi->get_crypto_price_technicals_rsi: %s\n" % e)
...
price_key = 'close' # str | The Crypto Currency Price field to use when calculating Simple Moving Average. (optional) (default to close)
timeframe = 'd1' # str | The time interval for the prices when calculating technicals. (optional) (default to d1)
timezone = 'UTC' # str | Return technical date/times in this timezone, also interpret start/end date/time parameters in this timezone. (optional) (default to UTC)
start_date = '' # date | Return technicals on or after this date. (optional)
start_time = '' # str | Return technicals at or after this time (24-hour). (optional)
...
try:
  api_response = crypto_api.get_crypto_price_technicals_sma(pair=pair, exchange=exchange, currency=currency, period=period, price_key=price_key, timeframe=timeframe, timezone=timezone, start_date=start_date, start_time=start_time, end_date=end_date, end_time=end_time, page_size=page_size, next_page=next_page)
  pprint(api_response)
except ApiException as e:
  print("Exception when calling CryptoApi->get_crypto_price_technicals_sma: %s\n" % e)
...
try:
  api_response = crypto_api.get_crypto_price_technicals_sr(pair=pair, exchange=exchange, currency=currency, period=period, signal_period=signal_period, timeframe=timeframe, timezone=timezone, start_date=start_date, start_time=start_time, end_date=end_date, end_time=end_time, page_size=page_size, next_page=next_page)
  pprint(api_response)
except ApiException as e:
  print("Exception when calling CryptoApi->get_crypto_price_technicals_sr: %s\n" % e)
...
try:
  api_response = crypto_api.get_crypto_price_technicals_trix(pair=pair, exchange=exchange, currency=currency, period=period, timeframe=timeframe, timezone=timezone, start_date=start_date, start_time=start_time, end_date=end_date, end_time=end_time, page_size=page_size, next_page=next_page)
  pprint(api_response)
except ApiException as e:
  print("Exception when calling CryptoApi->get_crypto_price_technicals_trix: %s\n" % e)
...
price_key = 'close' # str | The Crypto Currency Price field to use when calculating True Strength Index. (optional) (default to close)
timeframe = 'd1' # str | The time interval for the prices when calculating technicals. (optional) (default to d1)
timezone = 'UTC' # str | Return technical date/times in this timezone, also interpret start/end date/time parameters in this timezone. (optional) (default to UTC)
start_date = '' # date | Return technicals on or after this date. (optional)
start_time = '' # str | Return technicals at or after this time (24-hour). (optional)
...
try:
  api_response = crypto_api.get_crypto_price_technicals_tsi(pair=pair, exchange=exchange, currency=currency, low_period=low_period, high_period=high_period, price_key=price_key, timeframe=timeframe, timezone=timezone, start_date=start_date, start_time=start_time, end_date=end_date, end_time=end_time, page_size=page_size, next_page=next_page)
  pprint(api_response)
except ApiException as e:
  print("Exception when calling CryptoApi->get_crypto_price_technicals_tsi: %s\n" % e)
...
try:
  api_response = crypto_api.get_crypto_price_technicals_uo(pair=pair, exchange=exchange, currency=currency, short_period=short_period, medium_period=medium_period, long_period=long_period, short_weight=short_weight, medium_weight=medium_weight, long_weight=long_weight, timeframe=timeframe, timezone=timezone, start_date=start_date, start_time=start_time, end_date=end_date, end_time=end_time, page_size=page_size, next_page=next_page)
  pprint(api_response)
except ApiException as e:
  print("Exception when calling CryptoApi->get_crypto_price_technicals_uo: %s\n" % e)
...
try:
  api_response = crypto_api.get_crypto_price_technicals_vi(pair=pair, exchange=exchange, currency=currency, period=period, timeframe=timeframe, timezone=timezone, start_date=start_date, start_time=start_time, end_date=end_date, end_time=end_time, page_size=page_size, next_page=next_page)
  pprint(api_response)
except ApiException as e:
  print("Exception when calling CryptoApi->get_crypto_price_technicals_vi: %s\n" % e)
...
try:
  api_response = crypto_api.get_crypto_price_technicals_vpt(pair=pair, exchange=exchange, currency=currency, timeframe=timeframe, timezone=timezone, start_date=start_date, start_time=start_time, end_date=end_date, end_time=end_time, page_size=page_size, next_page=next_page)
  pprint(api_response)
except ApiException as e:
  print("Exception when calling CryptoApi->get_crypto_price_technicals_vpt: %s\n" % e)
...
try:
  api_response = crypto_api.get_crypto_price_technicals_vwap(pair=pair, exchange=exchange, currency=currency, timeframe=timeframe, timezone=timezone, start_date=start_date, start_time=start_time, end_date=end_date, end_time=end_time, page_size=page_size, next_page=next_page)
  pprint(api_response)
except ApiException as e:
  print("Exception when calling CryptoApi->get_crypto_price_technicals_vwap: %s\n" % e)
...
try:
  api_response = crypto_api.get_crypto_price_technicals_wr(pair=pair, exchange=exchange, currency=currency, period=period, timeframe=timeframe, timezone=timezone, start_date=start_date, start_time=start_time, end_date=end_date, end_time=end_time, page_size=page_size, next_page=next_page)
  pprint(api_response)
except ApiException as e:
  print("Exception when calling CryptoApi->get_crypto_price_technicals_wr: %s\n" % e)
...
[**View Intrinio API Documentation**](https://docs.intrinio.com/documentation/python/get_crypto_prices_v2)
...
exchange = 'binance' # str | Return prices for a Crypto Currency on the given Crypto Exchange. (optional)
...
Name | Type | Description  | Notes
------------- | ------------- | ------------- | -------------
 **timeframe** | str| The time interval for the prices. | [default to d1]  &nbsp;
...
[**View Intrinio API Documentation**](https://docs.intrinio.com/documentation/python/get_crypto_snapshot_v2)
...
exchange = 'binance' # str | Return the snapshot for a Crypto Currency on the given Crypto Exchange. (optional)
...
[**View Intrinio API Documentation**](https://docs.intrinio.com/documentation/python/get_crypto_stats_v2)
...
exchange = 'binance' # str | Returns stats for Crypto Currencies that trade on the specified Crypto Exchange. (optional)
