...
> ApiResponseFilings get_all_filings(company=company, report_type=report_type, start_date=start_date, end_date=end_date, industry_category=industry_category, industry_group=industry_group, earnings_release=earnings_release, page_size=page_size, next_page=next_page)
...
response = intrinio.FilingApi().get_all_filings(company=company, report_type=report_type, start_date=start_date, end_date=end_date, industry_category=industry_category, industry_group=industry_group, earnings_release=earnings_release, page_size=page_size, next_page=next_page)
print(response)
