...
> OptionSnapshotsResult get_security_snapshots(source=source, at_datetime=at_datetime)
...
response = intrinio.OptionsApi().get_security_snapshots(source=source, at_datetime=at_datetime)
print(response)
