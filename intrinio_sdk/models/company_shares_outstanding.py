...
class CompanySharesOutstanding(object):
    ...
    def __init__(self, xbrl_axis=None, xbrl_member=None, end_date=None, title_of_security=None, trading_symbol=None, security_exchange_name=None, shares_outstanding=None, adj_shares_outstanding=None):  # noqa: E501
        ...
        self._adj_shares_outstanding = None
        ...
        if adj_shares_outstanding is not None:
            self.adj_shares_outstanding = adj_shares_outstanding
    ...
    @property
    def adj_shares_outstanding(self):
        """Gets the adj_shares_outstanding of this CompanySharesOutstanding.  # noqa: E501

        Adjusted Shares Outstanding - The shares outstanding adjusted for stock splits that have occurred since the filing was reported, making it comparable to current share counts  # noqa: E501

        :return: The adj_shares_outstanding of this CompanySharesOutstanding.  # noqa: E501
        :rtype: float
        """
        return self._adj_shares_outstanding
        
    @property
    def adj_shares_outstanding_dict(self):
        """Gets the adj_shares_outstanding of this CompanySharesOutstanding.  # noqa: E501

        Adjusted Shares Outstanding - The shares outstanding adjusted for stock splits that have occurred since the filing was reported, making it comparable to current share counts as a dictionary. Useful for Panda Dataframes.  # noqa: E501
        ...
        value = self.adj_shares_outstanding
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
            ...
            result = { 'adj_shares_outstanding': value }

        
        return result
        

    @adj_shares_outstanding.setter
    def adj_shares_outstanding(self, adj_shares_outstanding):
        """Sets the adj_shares_outstanding of this CompanySharesOutstanding.

        Adjusted Shares Outstanding - The shares outstanding adjusted for stock splits that have occurred since the filing was reported, making it comparable to current share counts  # noqa: E501

        :param adj_shares_outstanding: The adj_shares_outstanding of this CompanySharesOutstanding.  # noqa: E501
        :type: float
        """

        self._adj_shares_outstanding = adj_shares_outstanding
