...
class CompanySharesOutstanding(object):
    ...
    def __init__(self, xbrl_axis=None, xbrl_member=None, title_of_security=None, trading_symbol=None, security_exchange_name=None, shares_outstanding=None):  # noqa: E501
