...
class OptionEod(object):
    ...
    def __init__(self, code=None, ticker=None, expiration=None, strike=None, type=None):  # noqa: E501
        """OptionEod - a model defined in Swagger"""  # noqa: E501
    ...
    @property
    def code(self):
        """Gets the code of this OptionEod.  # noqa: E501

        The Intrinio Code for the Option.  # noqa: E501

        :return: The code of this OptionEod.  # noqa: E501
        :rtype: str
        """
        return self._code
    ...
    @code.setter
    def code(self, code):
        """Sets the code of this OptionEod.

        The Intrinio Code for the Option.  # noqa: E501

        :param code: The code of this OptionEod.  # noqa: E501
        :type: str
        """
    ...
    @property
    def ticker(self):
        """Gets the ticker of this OptionEod.  # noqa: E501

        The ticker symbol of the Security for the Option.  # noqa: E501

        :return: The ticker of this OptionEod.  # noqa: E501
        :rtype: str
        """
        return self._ticker
    ...
    def ticker(self, ticker):
        """Sets the ticker of this OptionEod.

        The ticker symbol of the Security for the Option.  # noqa: E501

        :param ticker: The ticker of this OptionEod.  # noqa: E501
        :type: str
        """
    ...
    def expiration(self, expiration):
        """Sets the expiration of this OptionEod.

        The date on which the Option expires. The Option becomes invalid after this date and cannot be exercised.  # noqa: E501

        :param expiration: The expiration of this OptionEod.  # noqa: E501
        :type: str
        """
    ...
    @property
    def strike(self):
        """Gets the strike of this OptionEod.  # noqa: E501
        ...
        :return: The strike of this OptionEod.  # noqa: E501
        :rtype: float
        """
        return self._strike
    ...
    def strike(self, strike):
        """Sets the strike of this OptionEod.

        The strike price is the fixed price at which a derivative can be exercised, and refers to the price of the derivative’s underlying asset.  In a call option, the strike price is the price at which the option holder can purchase the underlying security.  For a put option, the strike price is the price at which the option holder can sell the underlying security.  # noqa: E501

        :param strike: The strike of this OptionEod.  # noqa: E501
        :type: float
        """
    ...
    @property
    def type(self):
        """Gets the type of this OptionEod.  # noqa: E501
        ...
        :return: The type of this OptionEod.  # noqa: E501
        :rtype: str
        """
        return self._type
    ...
    @type.setter
    def type(self, type):
        """Sets the type of this OptionEod.

        The type of Option (put or call). A put option is an option contract giving the owner the right, but not the obligation, to sell a specified amount of an underlying asset at a specified price before the option's expiration date. A call option gives the holder the right to buy an underlying asset at a specified price, before the option's expiration date.  # noqa: E501

        :param type: The type of this OptionEod.  # noqa: E501
        :type: str
        """
    ...
    def __eq__(self, other):
        ...
        if not isinstance(other, OptionEod):
            return False
