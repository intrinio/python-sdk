...
class Filing(object):
    ...
    def __init__(self, id=None, company=None, filing_date=None, accepted_date=None, period_end_date=None, report_type=None, sec_unique_id=None, filing_url=None, report_url=None, instance_url=None):  # noqa: E501
