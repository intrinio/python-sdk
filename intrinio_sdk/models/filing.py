...
class Filing(object):
    ...
    def __init__(self, id=None, filing_date=None, accepted_date=None, period_end_date=None, report_type=None, sec_unique_id=None, filing_url=None, report_url=None, instance_url=None, industry_category=None, industry_group=None, word_count=None, earnings_disclosed_at=None, earnings_disclosed_8k_id=None, earnings_8k_url=None, company=None):  # noqa: E501
        ...
        self._earnings_disclosed_8k_id = None
        self._earnings_8k_url = None
        self._company = None
        ...
        if earnings_disclosed_8k_id is not None:
            self.earnings_disclosed_8k_id = earnings_disclosed_8k_id
        if earnings_8k_url is not None:
            self.earnings_8k_url = earnings_8k_url
    ...
    def earnings_disclosed_at(self):
        """Gets the earnings_disclosed_at of this Filing.  # noqa: E501

        The date and time when the earnings information was first disclosed via 8-K filing  # noqa: E501

        :return: The earnings_disclosed_at of this Filing.  # noqa: E501
        :rtype: datetime
        """
    ...
    def earnings_disclosed_at(self, earnings_disclosed_at):
        """Sets the earnings_disclosed_at of this Filing.

        The date and time when the earnings information was first disclosed via 8-K filing  # noqa: E501

        :param earnings_disclosed_at: The earnings_disclosed_at of this Filing.  # noqa: E501
        :type: datetime
        """
    ...
    @property
    def earnings_disclosed_8k_id(self):
        """Gets the earnings_disclosed_8k_id of this Filing.  # noqa: E501

        The Intrinio ID of the 8-K filing where earnings were first disclosed  # noqa: E501

        :return: The earnings_disclosed_8k_id of this Filing.  # noqa: E501
        :rtype: str
        """
        return self._earnings_disclosed_8k_id
        
    @property
    def earnings_disclosed_8k_id_dict(self):
        """Gets the earnings_disclosed_8k_id of this Filing.  # noqa: E501

        The Intrinio ID of the 8-K filing where earnings were first disclosed as a dictionary. Useful for Panda Dataframes.  # noqa: E501
        ...
        value = self.earnings_disclosed_8k_id
        if isinstance(value, list):
            result = list(map(
                lambda x: x.to_dict() if hasattr(x, "to_dict") else x,
                value
            ...
            result = { 'earnings_disclosed_8k_id': value }

        
        return result
        

    @earnings_disclosed_8k_id.setter
    def earnings_disclosed_8k_id(self, earnings_disclosed_8k_id):
        """Sets the earnings_disclosed_8k_id of this Filing.

        The Intrinio ID of the 8-K filing where earnings were first disclosed  # noqa: E501

        :param earnings_disclosed_8k_id: The earnings_disclosed_8k_id of this Filing.  # noqa: E501
        :type: str
        """

        self._earnings_disclosed_8k_id = earnings_disclosed_8k_id

    @property
    def earnings_8k_url(self):
        """Gets the earnings_8k_url of this Filing.  # noqa: E501

        The URL to the 8-K filing page on the SEC site where earnings were first disclosed  # noqa: E501

        :return: The earnings_8k_url of this Filing.  # noqa: E501
        :rtype: str
        """
        return self._earnings_8k_url
        
    @property
    def earnings_8k_url_dict(self):
        """Gets the earnings_8k_url of this Filing.  # noqa: E501

        The URL to the 8-K filing page on the SEC site where earnings were first disclosed as a dictionary. Useful for Panda Dataframes.  # noqa: E501
        ...
        if isinstance(value, list):
            ...
            result = { 'earnings_8k_url': value }

        
        return result
        

    @earnings_8k_url.setter
    def earnings_8k_url(self, earnings_8k_url):
        """Sets the earnings_8k_url of this Filing.

        The URL to the 8-K filing page on the SEC site where earnings were first disclosed  # noqa: E501

        :param earnings_8k_url: The earnings_8k_url of this Filing.  # noqa: E501
        :type: str
        """

        self._earnings_8k_url = earnings_8k_url
