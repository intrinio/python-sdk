...
class SecurityApi(object):
    ...
    def get_all_securities(self, **kwargs):  # noqa: E501
        ...
        :param str code: Return securities classified with the given code (<a href=\"/documentation/security_codes\" target=\"_blank\">reference</a>).
    ...
    def get_all_securities_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['active', 'delisted', 'code', 'currency', 'ticker', 'name', 'composite_mic', 'exchange_mic', 'stock_prices_after', 'stock_prices_before', 'cik', 'figi', 'composite_figi', 'share_class_figi', 'figi_unique_id', 'include_non_figi', 'page_size', 'next_page']  # noqa: E501
