...
class SecurityApi(object):
    ...
    def get_security_trades_with_http_info(self, source, **kwargs):  # noqa: E501
        ...
        all_params = ['source', 'start_date', 'start_time', 'end_date', 'end_time', 'timezone', 'page_size', 'next_page']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_security_trades_by_symbol_with_http_info(self, identifier, source, **kwargs):  # noqa: E501
        ...
        all_params = ['identifier', 'source', 'start_date', 'start_time', 'end_date', 'end_time', 'timezone', 'darkpool_only', 'page_size', 'next_page']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
