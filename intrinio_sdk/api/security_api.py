...
class SecurityApi(object):
    ...
    def get_security_trades_by_symbol(self, source, **kwargs):  # noqa: E501
        ...
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_security_trades_by_symbol(source, _async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_security_trades_by_symbol_with_http_info(source, **kwargs)  # noqa: E501
        else:
            (data) = self.get_security_trades_by_symbol_with_http_info(source, **kwargs)  # noqa: E501
            return data

    def get_security_trades_by_symbol_with_http_info(self, source, **kwargs):  # noqa: E501
        """Security Trades By Symbol  # noqa: E501

        Returns all trades for a symbol between start time and end time, up to seven days ago for the specified source.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_security_trades_by_symbol_with_http_info(source, _async=True)
        >>> result = thread.get()
