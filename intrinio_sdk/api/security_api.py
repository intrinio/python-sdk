...
class SecurityApi(object):
    ...
    def get_securities_daily_short_volume(self, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_securities_daily_short_volume_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_securities_daily_short_volume_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_securities_daily_short_volume_with_http_info(self, **kwargs):  # noqa: E501
        """Daily Short Volume  # noqa: E501

        Returns FINRA daily short volume data for securities, reported by individual market centers and reporting facilities.  ## Data Coverage This endpoint provides **off-exchange activity** data aggregated from FINRA's Short Sale Volume files. The data represents short selling activity reported by market centers and third-party reporting facilities, including both exchange and off-exchange venues.  ## Use as Market Proxy Short volume data can serve as a meaningful proxy for overall market sentiment and activity: - **Market Structure Insight**: Tracks short selling intensity across different trading venues and market centers - **Liquidity Indicator**: Higher short volume often correlates with increased market activity and liquidity - **Sentiment Analysis**: Can indicate bearish positioning, though short volume alone doesn't determine market direction - **Cross-Venue Analysis**: Compare short volume patterns across different reporting facilities to understand how activity varies by venue type  ## Data Characteristics - Data is reported at the facility level for granular analysis - Use the `/securities/daily_short_volume/consolidated` endpoint for a single aggregated view across all facilities - Short exempt volume reflects pre-borrow arrangements and other regulated short selling exemptions - Each data point represents a full trading day's accumulated short volume   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_securities_daily_short_volume_with_http_info(_async=True)
        >>> result = thread.get()
        ...
        all_params = ['tickers', 'start_date', 'end_date', 'sort_by', 'next_page']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_securities_daily_short_volume" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/securities/daily_short_volume', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='ApiResponseSecuritiesDailyShortVolume',  # noqa: E501
            auth_settings=auth_settings,
            _async=params.get('async'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_securities_daily_short_volume_consolidated(self, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_securities_daily_short_volume_consolidated_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_securities_daily_short_volume_consolidated_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_securities_daily_short_volume_consolidated_with_http_info(self, **kwargs):  # noqa: E501
        """Daily Short Volume Consolidated  # noqa: E501

        Returns FINRA daily short volume data aggregated across all reporting facilities for each security and date.  ## Data Aggregation This endpoint consolidates all short volume activity reported across different market centers and reporting facilities into a single daily view per security: - **Volume Summation**: Total, short, and short exempt volumes are summed across all facilities - **Ratio Recalculation**: The short volume ratio is recalculated on the aggregated totals for accurate market-wide percentages - **Facility Tracking**: Included `sources` field lists all reporting facilities that contributed to each daily aggregate  ## Market-Wide Perspective Consolidated short volume serves as an excellent proxy for off-exchange market activity: - **Complete Market View**: Aggregates activity from all FINRA-reporting venues into a single metric - **Comparable Across Securities**: Normalized short volume ratios allow fair comparison between different stocks regardless of absolute trading volume - **Trend Analysis**: Daily consolidated data enables tracking of short selling trends and patterns across the entire market - **Venue-Agnostic**: Eliminates the need to aggregate across multiple facilities manually  ## Use Cases - Monitor overall short selling sentiment across your portfolio or watchlist - Identify unusual short volume spikes that may precede price moves - Compare short volume ratios between securities to identify relative short interest positioning - Analyze temporal patterns in short selling behavior across trading days   # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_securities_daily_short_volume_consolidated_with_http_info(_async=True)
        >>> result = thread.get()
        ...
        all_params = ['tickers', 'start_date', 'end_date', 'next_page']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_securities_daily_short_volume_consolidated" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            '/securities/daily_short_volume/consolidated', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='ApiResponseSecuritiesDailyShortVolumeConsolidated',  # noqa: E501
            auth_settings=auth_settings,
            _async=params.get('async'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_securities_latest_dividend_records(self, **kwargs):  # noqa: E501
        """Latest Dividend Records for All Securities  # noqa: E501

        Returns the latest available dividend information for all securities. Returns one dividend record per security, limited to records from the last 90 days, sorted by date_loaded in descending order.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_securities_latest_dividend_records(_async=True)
        >>> result = thread.get()

        :param async bool
        :param int page_size: The number of results to return
        :param str next_page: Gets the next page of data from a previous API call
        :param date date: Return dividend records on or before this date. Format YYYY-MM-DD
        :param str identifiers: A comma-delimited list of security identifiers (tickers, CUSIPs, ISINs, etc.)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_securities_latest_dividend_records_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_securities_latest_dividend_records_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_securities_latest_dividend_records_with_http_info(self, **kwargs):  # noqa: E501
        """Latest Dividend Records for All Securities  # noqa: E501

        Returns the latest available dividend information for all securities. Returns one dividend record per security, limited to records from the last 90 days, sorted by date_loaded in descending order.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_securities_latest_dividend_records_with_http_info(_async=True)
        >>> result = thread.get()
        ...
        all_params = ['page_size', 'next_page', 'date', 'identifiers', 'next_page2']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_securities_latest_dividend_records" % key
                )
            params[key] = val
        del params['kwargs']

        if 'page_size' in params and params['page_size'] > 10000:  # noqa: E501
            raise ValueError("Invalid value for parameter `page_size` when calling `get_securities_latest_dividend_records`, must be a value less than or equal to `10000`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/securities/dividends/latest', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='ApiResponseSecuritiesDividendLatest',  # noqa: E501
            auth_settings=auth_settings,
            _async=params.get('async'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_securities_latest_earnings_records(self, **kwargs):  # noqa: E501
        """Latest Earnings Records for All Securities  # noqa: E501

        Returns the latest available earnings information for all securities. Returns one earnings record per security, limited to records from the last 90 days, sorted by date_loaded in descending order.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_securities_latest_earnings_records(_async=True)
        >>> result = thread.get()

        :param async bool
        :param int page_size: The number of results to return
        :param str next_page: Gets the next page of data from a previous API call
        :param date date: Return earnings records on or before this date. Format YYYY-MM-DD
        :param str identifiers: A comma-delimited list of security identifiers (tickers, CUSIPs, ISINs, etc.)
        :param str next_page2: Gets the next page of data from a previous API call
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_securities_latest_earnings_records_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_securities_latest_earnings_records_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_securities_latest_earnings_records_with_http_info(self, **kwargs):  # noqa: E501
        """Latest Earnings Records for All Securities  # noqa: E501

        Returns the latest available earnings information for all securities. Returns one earnings record per security, limited to records from the last 90 days, sorted by date_loaded in descending order.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_securities_latest_earnings_records_with_http_info(_async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_securities_latest_earnings_records" % key
                )
            params[key] = val
        del params['kwargs']

        if 'page_size' in params and params['page_size'] > 10000:  # noqa: E501
            raise ValueError("Invalid value for parameter `page_size` when calling `get_securities_latest_earnings_records`, must be a value less than or equal to `10000`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/securities/earnings/latest', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='ApiResponseSecuritiesEarningsLatest',  # noqa: E501
            auth_settings=auth_settings,
            _async=params.get('async'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_securities_short_interest(self, **kwargs):  # noqa: E501
        """Latest Short Interest  # noqa: E501

        Returns the latest short interest data for all securities. The data covers the most recent settlement date and up to 13 days prior, sorted by percentage change in descending order. Each short interest record includes the associated security information.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_securities_short_interest(_async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_securities_short_interest_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.get_securities_short_interest_with_http_info(**kwargs)  # noqa: E501
            return data

    def get_securities_short_interest_with_http_info(self, **kwargs):  # noqa: E501
        """Latest Short Interest  # noqa: E501

        Returns the latest short interest data for all securities. The data covers the most recent settlement date and up to 13 days prior, sorted by percentage change in descending order. Each short interest record includes the associated security information.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_securities_short_interest_with_http_info(_async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_securities_short_interest" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='ApiResponseSecuritiesShortInterest',  # noqa: E501
            auth_settings=auth_settings,
            _async=params.get('async'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_security_price_technicals_dc(self, identifier, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param str identifier: A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID) (required)
        :param int period: The number of observations to calculate Donchian Channel
    ...
    def get_security_price_technicals_dpo(self, identifier, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param str identifier: A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID) (required)
        :param int period: The number of observations to calculate Detrended Price Oscillator
    ...
    def get_security_price_technicals_eom(self, identifier, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param str identifier: A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID) (required)
        :param int period: The number of observations to calculate Ease of Movement
        :param str start_date: Return technical indicator values on or after the date
        :param str end_date: Return technical indicator values on or before the date
        :param int page_size: The number of results to return
        :param str next_page: Gets the next page of data from a previous API call
    ...
    def get_security_price_technicals_ichimoku(self, identifier, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param str identifier: A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID) (required)
        :param int low_period: The number of observations to calculate Tenkan Sen (Conversion Line) of Ichimoku Kinko Hyo
        :param int medium_period: The number of observations to calculate Kijun Sen (Base Line), Senkou Span A (Leading Span A), and Chikou Span (Lagging Span) of Ichimoku Kinko Hyo
        :param int high_period: The number of observations to calculate Senkou Span B (Leading Span B) of Ichimoku Kinko Hyo
        :param str start_date: Return technical indicator values on or after the date
        :param str end_date: Return technical indicator values on or before the date
        :param int page_size: The number of results to return
        :param str next_page: Gets the next page of data from a previous API call
    ...
    def get_security_price_technicals_kc(self, identifier, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param str identifier: A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID) (required)
        :param int period: The number of observations to calculate Kelter Channel
        :param str start_date: Return technical indicator values on or after the date
        :param str end_date: Return technical indicator values on or before the date
        :param int page_size: The number of results to return
        :param str next_page: Gets the next page of data from a previous API call
    ...
    def get_security_price_technicals_kst(self, identifier, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param str identifier: A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID) (required)
        :param int roc1: The number of observations to calculate the rate-of-change for RCMA1
        :param int roc2: The number of observations to calculate the rate-of-change for RCMA2
        :param int roc3: The number of observations to calculate the rate-of-change for RCMA3
        :param int roc4: The number of observations to calculate the rate-of-change for RCMA4
        :param int sma1: The number of observations to calculate the Simple Moving Average of the rate-of-change for RCMA1
        :param int sma2: The number of observations to calculate the Simple Moving Average of the rate-of-change for RCMA2
        :param int sma3: The number of observations to calculate the Simple Moving Average of the rate-of-change for RCMA3
        :param int sma4: The number of observations to calculate the Simple Moving Average of the rate-of-change for RCMA4
    ...
    def get_security_price_technicals_macd(self, identifier, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param str identifier: A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID) (required)
        :param int fast_period: The number of observations to calculate the fast moving Exponential Moving Average for Moving Average Convergence Divergence
        :param int slow_period: The number of observations to calculate the slow moving Exponential Moving Average for Moving Average Convergence Divergence
        :param int signal_period: The number of observations to calculate the signal line for Moving Average Convergence Divergence
    ...
    def get_security_price_technicals_mfi(self, identifier, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param str identifier: A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID) (required)
        :param int period: The number of observations to calculate Money Flow Index
        :param str start_date: Return technical indicator values on or after the date
        :param str end_date: Return technical indicator values on or before the date
        :param int page_size: The number of results to return
        :param str next_page: Gets the next page of data from a previous API call
    ...
    def get_security_price_technicals_mi(self, identifier, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param str identifier: A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID) (required)
        :param int ema_period: The number of observations to calculate the single Exponential Moving Average and the Double Exponential Moving Average for Mass Index
        :param int sum_period: The number of observations to calculate the sum of the Exponetinal Moving Average Ratios for Mass Index
        :param str start_date: Return technical indicator values on or after the date
        :param str end_date: Return technical indicator values on or before the date
        :param int page_size: The number of results to return
        :param str next_page: Gets the next page of data from a previous API call
    ...
    def get_security_price_technicals_obv_mean(self, identifier, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param str identifier: A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID) (required)
        :param int period: The number of observations to calculate On-balance Volume Mean
        :param str start_date: Return technical indicator values on or after the date
        :param str end_date: Return technical indicator values on or before the date
        :param int page_size: The number of results to return
        :param str next_page: Gets the next page of data from a previous API call
    ...
    def get_security_price_technicals_rsi(self, identifier, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param str identifier: A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID) (required)
        :param int period: The number of observations to calculate Relative Strength Index
    ...
    def get_security_price_technicals_sma(self, identifier, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param str identifier: A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID) (required)
        :param int period: The number of observations to calculate Simple Moving Average
    ...
    def get_security_price_technicals_sr(self, identifier, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param str identifier: A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID) (required)
        :param int period: The number of observations to calculate %K of Stochastic Oscillator
        :param int signal_period: The number of observations to calculate the %D (the Simple Moving Average of %K) as a signal line for Stochastic Oscillator
        :param str start_date: Return technical indicator values on or after the date
        :param str end_date: Return technical indicator values on or before the date
        :param int page_size: The number of results to return
        :param str next_page: Gets the next page of data from a previous API call
    ...
    def get_security_price_technicals_trix(self, identifier, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param str identifier: A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID) (required)
        :param int period: The number of observations to calculate Exponential Moving Average for Triple Exponential Average
        :param str start_date: Return technical indicator values on or after the date
        :param str end_date: Return technical indicator values on or before the date
        :param int page_size: The number of results to return
        :param str next_page: Gets the next page of data from a previous API call
    ...
    def get_security_price_technicals_tsi(self, identifier, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param str identifier: A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID) (required)
        :param int low_period: The number of observations to calculate low period Exponential Moving Average for smoothing in True Strength Index
        :param int high_period: The number of observations to calculate high period Exponential Moving Average for smoothing in True Strength Index
    ...
    def get_security_price_technicals_uo(self, identifier, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param str identifier: A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID) (required)
        :param int short_period: The number of observations to calculate the short period for Ultimate Oscillator
        :param int medium_period: The number of observations to calculate the medium period for Ultimate Oscillator
        :param int long_period: The number of observations to calculate the long period for Ultimate Oscillator
    ...
    def get_security_price_technicals_vi(self, identifier, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param str identifier: A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID) (required)
        :param int period: The number of observations to calculate Vortex Indicator
        :param str start_date: Return technical indicator values on or after the date
        :param str end_date: Return technical indicator values on or before the date
        :param int page_size: The number of results to return
        :param str next_page: Gets the next page of data from a previous API call
    ...
    def get_security_price_technicals_wr(self, identifier, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param str identifier: A Security identifier (Ticker, FIGI, ISIN, CUSIP, Intrinio ID) (required)
        :param int period: The number of observations to look-back when calculating Williams %R
        :param str start_date: Return technical indicator values on or after the date
        :param str end_date: Return technical indicator values on or before the date
    ...
    def get_security_short_interest(self, identifier, **kwargs):  # noqa: E501
        """Short Interest by Security  # noqa: E501

        Returns historical short interest data for a given security. Short interest data includes settlement date, current and previous short positions, percentage change, days to cover, and average daily volume.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_security_short_interest(identifier, _async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_security_short_interest_with_http_info(identifier, **kwargs)  # noqa: E501
        else:
            (data) = self.get_security_short_interest_with_http_info(identifier, **kwargs)  # noqa: E501
            return data

    def get_security_short_interest_with_http_info(self, identifier, **kwargs):  # noqa: E501
        """Short Interest by Security  # noqa: E501

        Returns historical short interest data for a given security. Short interest data includes settlement date, current and previous short positions, percentage change, days to cover, and average daily volume.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_security_short_interest_with_http_info(identifier, _async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_security_short_interest" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'identifier' is set
        if ('identifier' not in params or
                params['identifier'] is None):
            raise ValueError("Missing the required parameter `identifier` when calling `get_security_short_interest`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/securities/{identifier}/short_interest', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='ApiResponseSecurityShortInterest',  # noqa: E501
            auth_settings=auth_settings,
            _async=params.get('async'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_security_snapshots(self, **kwargs):  # noqa: E501
        ...
        :param str source: Return the snapshot from the specified source.
    ...
    def get_security_snapshots_with_http_info(self, **kwargs):  # noqa: E501
        ...
        all_params = ['at_datetime', 'source']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def get_security_stock_price_adjustments_dividends(self, identifier, **kwargs):  # noqa: E501
        """Dividends by Security  # noqa: E501

        Returns dividend price adjustments for the Security with the given `identifier`. A filtered api of /securities/{identifier}/prices/adjustments.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_security_stock_price_adjustments_dividends(identifier, _async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_security_stock_price_adjustments_dividends_with_http_info(identifier, **kwargs)  # noqa: E501
        else:
            (data) = self.get_security_stock_price_adjustments_dividends_with_http_info(identifier, **kwargs)  # noqa: E501
            return data

    def get_security_stock_price_adjustments_dividends_with_http_info(self, identifier, **kwargs):  # noqa: E501
        """Dividends by Security  # noqa: E501

        Returns dividend price adjustments for the Security with the given `identifier`. A filtered api of /securities/{identifier}/prices/adjustments.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_security_stock_price_adjustments_dividends_with_http_info(identifier, _async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_security_stock_price_adjustments_dividends" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'identifier' is set
        if ('identifier' not in params or
                params['identifier'] is None):
            raise ValueError("Missing the required parameter `identifier` when calling `get_security_stock_price_adjustments_dividends`")  # noqa: E501

        if 'page_size' in params and params['page_size'] > 10000:  # noqa: E501
            raise ValueError("Invalid value for parameter `page_size` when calling `get_security_stock_price_adjustments_dividends`, must be a value less than or equal to `10000`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/securities/{identifier}/prices/adjustments/dividends', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_security_stock_price_adjustments_splits(self, identifier, **kwargs):  # noqa: E501
        """Splits by Security  # noqa: E501

        Returns stock price split adjustments for the Security with the given `identifier`.  A filtered api of /securities/{identifier}/prices/adjustments.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_security_stock_price_adjustments_splits(identifier, _async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_security_stock_price_adjustments_splits_with_http_info(identifier, **kwargs)  # noqa: E501
        else:
            (data) = self.get_security_stock_price_adjustments_splits_with_http_info(identifier, **kwargs)  # noqa: E501
            return data

    def get_security_stock_price_adjustments_splits_with_http_info(self, identifier, **kwargs):  # noqa: E501
        """Splits by Security  # noqa: E501

        Returns stock price split adjustments for the Security with the given `identifier`.  A filtered api of /securities/{identifier}/prices/adjustments.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_security_stock_price_adjustments_splits_with_http_info(identifier, _async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_security_stock_price_adjustments_splits" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'identifier' is set
        if ('identifier' not in params or
                params['identifier'] is None):
            raise ValueError("Missing the required parameter `identifier` when calling `get_security_stock_price_adjustments_splits`")  # noqa: E501

        if 'page_size' in params and params['page_size'] > 10000:  # noqa: E501
            raise ValueError("Invalid value for parameter `page_size` when calling `get_security_stock_price_adjustments_splits`, must be a value less than or equal to `10000`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/securities/{identifier}/prices/adjustments/splits', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_security_trading_status(self, identifier, source, **kwargs):  # noqa: E501
        """Security Trading Status By Security  # noqa: E501

        Returns trading status for the specified security.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_security_trading_status(identifier, source, _async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_security_trading_status_with_http_info(identifier, source, **kwargs)  # noqa: E501
        else:
            (data) = self.get_security_trading_status_with_http_info(identifier, source, **kwargs)  # noqa: E501
            return data

    def get_security_trading_status_with_http_info(self, identifier, source, **kwargs):  # noqa: E501
        """Security Trading Status By Security  # noqa: E501

        Returns trading status for the specified security.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_security_trading_status_with_http_info(identifier, source, _async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_security_trading_status" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'identifier' is set
        if ('identifier' not in params or
                params['identifier'] is None):
            raise ValueError("Missing the required parameter `identifier` when calling `get_security_trading_status`")  # noqa: E501
        # verify the required parameter 'source' is set
        if ('source' not in params or
                params['source'] is None):
            raise ValueError("Missing the required parameter `source` when calling `get_security_trading_status`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/securities/{identifier}/trading_status', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='ApiResponseSecurityTradingStatus',  # noqa: E501
            auth_settings=auth_settings,
            _async=params.get('async'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_security_trading_status_quotes_only(self, source, **kwargs):  # noqa: E501
        """Security Trading Status Quotes Only  # noqa: E501

        Returns all securities where the current trading status is quotes_only for the specified source.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_security_trading_status_quotes_only(source, _async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_security_trading_status_quotes_only_with_http_info(source, **kwargs)  # noqa: E501
        else:
            (data) = self.get_security_trading_status_quotes_only_with_http_info(source, **kwargs)  # noqa: E501
            return data

    def get_security_trading_status_quotes_only_with_http_info(self, source, **kwargs):  # noqa: E501
        """Security Trading Status Quotes Only  # noqa: E501

        Returns all securities where the current trading status is quotes_only for the specified source.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_security_trading_status_quotes_only_with_http_info(source, _async=True)
        >>> result = thread.get()
        ...
        all_params = ['source', 'page_size', 'next_page']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_security_trading_status_quotes_only" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'source' is set
        if ('source' not in params or
                params['source'] is None):
            raise ValueError("Missing the required parameter `source` when calling `get_security_trading_status_quotes_only`")  # noqa: E501

        if 'page_size' in params and params['page_size'] > 500:  # noqa: E501
            raise ValueError("Invalid value for parameter `page_size` when calling `get_security_trading_status_quotes_only`, must be a value less than or equal to `500`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/securities/trading_status/quotes_only', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='ApiResponseSecurityTradingStatuses',  # noqa: E501
            auth_settings=auth_settings,
            _async=params.get('async'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_security_trading_status_stopped(self, source, **kwargs):  # noqa: E501
        """Security Trading Status Stopped  # noqa: E501

        Returns all securities where the current trading status is stopped for the specified source.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_security_trading_status_stopped(source, _async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_security_trading_status_stopped_with_http_info(source, **kwargs)  # noqa: E501
        else:
            (data) = self.get_security_trading_status_stopped_with_http_info(source, **kwargs)  # noqa: E501
            return data

    def get_security_trading_status_stopped_with_http_info(self, source, **kwargs):  # noqa: E501
        """Security Trading Status Stopped  # noqa: E501

        Returns all securities where the current trading status is stopped for the specified source.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_security_trading_status_stopped_with_http_info(source, _async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_security_trading_status_stopped" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'source' is set
        if ('source' not in params or
                params['source'] is None):
            raise ValueError("Missing the required parameter `source` when calling `get_security_trading_status_stopped`")  # noqa: E501

        if 'page_size' in params and params['page_size'] > 500:  # noqa: E501
            raise ValueError("Invalid value for parameter `page_size` when calling `get_security_trading_status_stopped`, must be a value less than or equal to `500`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/securities/trading_status/stopped', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
    ...
    def get_security_trading_status_trading(self, source, **kwargs):  # noqa: E501
        """Security Trading Status Trading  # noqa: E501

        Returns all securities where the current trading status is trading for the specified source.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_security_trading_status_trading(source, _async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_security_trading_status_trading_with_http_info(source, **kwargs)  # noqa: E501
        else:
            (data) = self.get_security_trading_status_trading_with_http_info(source, **kwargs)  # noqa: E501
            return data

    def get_security_trading_status_trading_with_http_info(self, source, **kwargs):  # noqa: E501
        """Security Trading Status Trading  # noqa: E501

        Returns all securities where the current trading status is trading for the specified source.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_security_trading_status_trading_with_http_info(source, _async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_security_trading_status_trading" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'source' is set
        if ('source' not in params or
                params['source'] is None):
            raise ValueError("Missing the required parameter `source` when calling `get_security_trading_status_trading`")  # noqa: E501

        if 'page_size' in params and params['page_size'] > 500:  # noqa: E501
            raise ValueError("Invalid value for parameter `page_size` when calling `get_security_trading_status_trading`, must be a value less than or equal to `500`")  # noqa: E501
        collection_formats = {}
        ...
        return self.api_client.call_api(
            '/securities/trading_status/trading', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
