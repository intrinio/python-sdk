...
class SecurityApi(object):
    ...
    def get_security_trades_by_symbol(self, identifier, source, **kwargs):  # noqa: E501
        ...
        :param str source: The specific source of the data being requested.  Specifying delayed sip will result in the system automatically determining which delayed sip source (cta_delayed, cta_b_delayed, utp_delayed) to use. (required)
        :param date start_date: The start date for the data being requested.
        :param str start_time: The start time for the data being requested.
        :param date end_date: The end date for the data being requested.
        :param str end_time: The end time for the data being requested.
