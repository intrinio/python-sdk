...
class CompanyApi(object):
    ...
    def insider_transaction_filings_by_company_with_http_info(self, identifier, **kwargs):  # noqa: E501
        ...
        all_params = ['identifier', 'start_date', 'end_date', 'ownership_type', 'page_size', 'next_page']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        if 'page_size' in params and params['page_size'] > 10000:  # noqa: E501
            raise ValueError("Invalid value for parameter `page_size` when calling `insider_transaction_filings_by_company`, must be a value less than or equal to `10000`")  # noqa: E501
        collection_formats = {}
    ...
    def latest_insider_transaction_filing_by_company_with_http_info(self, identifier, **kwargs):  # noqa: E501
        ...
        if 'page_size' in params and params['page_size'] > 10000:  # noqa: E501
            raise ValueError("Invalid value for parameter `page_size` when calling `latest_insider_transaction_filing_by_company`, must be a value less than or equal to `10000`")  # noqa: E501
        collection_formats = {}
