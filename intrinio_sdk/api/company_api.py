...
class CompanyApi(object):
    ...
    def get_company_filings(self, identifier, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param str identifier: A Company identifier (Ticker, CIK, LEI, Intrinio ID) (required)
        :param str report_type: Filter by <a href=\"/documentation/sec_filing_report_types\" target=\"_blank\">report type</a>. Separate values with commas to return multiple report types.
