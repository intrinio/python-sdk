...
class CompanyApi(object):
    ...
    def filter_companies(self, **kwargs):  # noqa: E501
        ...
        :param async bool
        :param date last_filing_date: Last filing date
        ...
        if kwargs.get('async'):
            return self.filter_companies_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.filter_companies_with_http_info(**kwargs)  # noqa: E501
            return data

    def filter_companies_with_http_info(self, **kwargs):  # noqa: E501
        """Filter Companies  # noqa: E501
        ...
        all_params = ['last_filing_date', 'sic', 'template', 'sector', 'industry_category', 'industry_group', 'next_page']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method filter_companies" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        query_params = []
        if 'last_filing_date' in params:
            query_params.append(('last_filing_date', params['last_filing_date']))  # noqa: E501
        if 'sic' in params:
        ...
        return self.api_client.call_api(
            ...
            response_type='list[CompanySummary]',  # noqa: E501
    ...
    def filter_company_fundamentals(self, identifier, **kwargs):  # noqa: E501
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.filter_company_fundamentals_with_http_info(identifier, **kwargs)  # noqa: E501
        else:
            (data) = self.filter_company_fundamentals_with_http_info(identifier, **kwargs)  # noqa: E501
            return data

    def filter_company_fundamentals_with_http_info(self, identifier, **kwargs):  # noqa: E501
        """Filter Fundamentals for a Company  # noqa: E501
        ...
        all_params = ['identifier', 'filed_after', 'filed_before', 'reported_only', 'fiscal_year', 'statement_code', 'type', 'start_date', 'end_date', 'next_page']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method filter_company_fundamentals" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('identifier' not in params or
            ...
            raise ValueError("Missing the required parameter `identifier` when calling `filter_company_fundamentals`")  # noqa: E501
    ...
    def get_all_company_filings(self, identifier, **kwargs):  # noqa: E501
        """Filings  # noqa: E501

        Returns a complete list of SEC filings for the Company with the given `identifier`  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_all_company_filings(identifier, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_all_company_filings_with_http_info(identifier, **kwargs)  # noqa: E501
        else:
            (data) = self.get_all_company_filings_with_http_info(identifier, **kwargs)  # noqa: E501
            return data

    def get_all_company_filings_with_http_info(self, identifier, **kwargs):  # noqa: E501
        """Filings  # noqa: E501

        Returns a complete list of SEC filings for the Company with the given `identifier`  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_all_company_filings_with_http_info(identifier, async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_all_company_filings" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'identifier' is set
        if ('identifier' not in params or
                params['identifier'] is None):
            raise ValueError("Missing the required parameter `identifier` when calling `get_all_company_filings`")  # noqa: E501
        ...
        return self.api_client.call_api(
            ...
            post_params=form_params,
            files=local_var_files,
            response_type='list[FilingSummary]',  # noqa: E501
            auth_settings=auth_settings,
            async=params.get('async'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_all_company_fundamentals(self, identifier, **kwargs):  # noqa: E501
        """Get All Fundamentals for a Company  # noqa: E501

        Returns all Fundamentals for the Company with the given `identifier`  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_all_company_fundamentals(identifier, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_all_company_fundamentals_with_http_info(identifier, **kwargs)  # noqa: E501
        else:
            (data) = self.get_all_company_fundamentals_with_http_info(identifier, **kwargs)  # noqa: E501
            return data

    def get_all_company_fundamentals_with_http_info(self, identifier, **kwargs):  # noqa: E501
        """Get All Fundamentals for a Company  # noqa: E501

        Returns all Fundamentals for the Company with the given `identifier`  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_all_company_fundamentals_with_http_info(identifier, async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method get_all_company_fundamentals" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'identifier' is set
        if ('identifier' not in params or
                params['identifier'] is None):
            raise ValueError("Missing the required parameter `identifier` when calling `get_all_company_fundamentals`")  # noqa: E501
    ...
    def get_company_data_point_number(self, identifier, item, **kwargs):  # noqa: E501
        """Get Company Data Point (Number)  # noqa: E501

        Returns a numeric value for the given `item` for the Company with the given `identifier`  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_company_data_point_number(identifier, item, async=True)
        >>> result = thread.get()

        :param async bool
        :param str identifier: A Company identifier (Ticker, CIK, LEI, Intrinio ID) (required)
        :param str item: An Intrinio data tag (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_company_data_point_number_with_http_info(identifier, item, **kwargs)  # noqa: E501
        else:
            (data) = self.get_company_data_point_number_with_http_info(identifier, item, **kwargs)  # noqa: E501
            return data

    def get_company_data_point_number_with_http_info(self, identifier, item, **kwargs):  # noqa: E501
        """Get Company Data Point (Number)  # noqa: E501

        Returns a numeric value for the given `item` for the Company with the given `identifier`  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_company_data_point_number_with_http_info(identifier, item, async=True)
        >>> result = thread.get()
        ...
        if ('item' not in params or
                params['item'] is None):
            raise ValueError("Missing the required parameter `item` when calling `get_company_data_point_number`")  # noqa: E501
    ...
    def get_company_data_point_text(self, identifier, item, **kwargs):  # noqa: E501
        """Get Company Data Point (Text)  # noqa: E501

        Returns a text value for the given `item` for the Company with the given `identifier`  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_company_data_point_text(identifier, item, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_company_data_point_text_with_http_info(identifier, item, **kwargs)  # noqa: E501
        else:
            (data) = self.get_company_data_point_text_with_http_info(identifier, item, **kwargs)  # noqa: E501
            return data

    def get_company_data_point_text_with_http_info(self, identifier, item, **kwargs):  # noqa: E501
        """Get Company Data Point (Text)  # noqa: E501

        Returns a text value for the given `item` for the Company with the given `identifier`  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_company_data_point_text_with_http_info(identifier, item, async=True)
        >>> result = thread.get()
        ...
        if ('item' not in params or
                params['item'] is None):
            raise ValueError("Missing the required parameter `item` when calling `get_company_data_point_text`")  # noqa: E501
    ...
    def get_company_historical_data(self, identifier, item, **kwargs):  # noqa: E501
        """Get Company Historical Data  # noqa: E501

        Returns historical values for the given `item` and the Company with the given `identifier`  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_company_historical_data(identifier, item, async=True)
        >>> result = thread.get()

        :param async bool
        :param str identifier: A Company identifier (Ticker, CIK, LEI, Intrinio ID) (required)
        :param str item: Item (required)
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_company_historical_data_with_http_info(identifier, item, **kwargs)  # noqa: E501
        else:
            (data) = self.get_company_historical_data_with_http_info(identifier, item, **kwargs)  # noqa: E501
            return data

    def get_company_historical_data_with_http_info(self, identifier, item, **kwargs):  # noqa: E501
        """Get Company Historical Data  # noqa: E501

        Returns historical values for the given `item` and the Company with the given `identifier`  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_company_historical_data_with_http_info(identifier, item, async=True)
        >>> result = thread.get()
        ...
        if ('item' not in params or
                params['item'] is None):
            raise ValueError("Missing the required parameter `item` when calling `get_company_historical_data`")  # noqa: E501
    ...
    def get_news(self, identifier, **kwargs):  # noqa: E501
        """News  # noqa: E501

        Returns news for the Company with the given `identifier`  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_news(identifier, async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.get_news_with_http_info(identifier, **kwargs)  # noqa: E501
        else:
            (data) = self.get_news_with_http_info(identifier, **kwargs)  # noqa: E501
            return data

    def get_news_with_http_info(self, identifier, **kwargs):  # noqa: E501
        """News  # noqa: E501

        Returns news for the Company with the given `identifier`  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_news_with_http_info(identifier, async=True)
        >>> result = thread.get()
        ...
        if ('identifier' not in params or
                params['identifier'] is None):
            raise ValueError("Missing the required parameter `identifier` when calling `get_news`")  # noqa: E501
