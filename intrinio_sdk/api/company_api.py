...
class CompanyApi(object):
    ...
    def all_expected_earnings_dates(self, **kwargs):  # noqa: E501
        """All Expected Earnings Dates  # noqa: E501

        Returns expected earnings announcement dates for all companies, optionally filtered by tickers. Results are always sorted by expected date ascending and include company identification.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.all_expected_earnings_dates(_async=True)
        >>> result = thread.get()

        :param async bool
        :param str tickers: Comma-delimited list of tickers to filter results
        :param int fiscal_year: Filter by fiscal year
        :param str fiscal_period: Filter by fiscal period (Q1, Q2, Q3, FY)
        :param date expected_date_after: Returns expected dates on or after this date. Defaults to today if not provided.
        :param date expected_date_before: Returns expected dates before this date.
        ...
        if kwargs.get('async'):
            return self.all_expected_earnings_dates_with_http_info(**kwargs)  # noqa: E501
        else:
            (data) = self.all_expected_earnings_dates_with_http_info(**kwargs)  # noqa: E501
            return data

    def all_expected_earnings_dates_with_http_info(self, **kwargs):  # noqa: E501
        """All Expected Earnings Dates  # noqa: E501

        Returns expected earnings announcement dates for all companies, optionally filtered by tickers. Results are always sorted by expected date ascending and include company identification.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.all_expected_earnings_dates_with_http_info(_async=True)
        >>> result = thread.get()
        ...
        all_params = ['tickers', 'fiscal_year', 'fiscal_period', 'expected_date_after', 'expected_date_before', 'page_size', 'next_page']  # noqa: E501
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    ...
                    " to method all_expected_earnings_dates" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if 'expected_date_after' in params:
            query_params.append(('expected_date_after', params['expected_date_after']))  # noqa: E501
        if 'expected_date_before' in params:
            query_params.append(('expected_date_before', params['expected_date_before']))  # noqa: E501
        ...
        return self.api_client.call_api(
            '/companies/upcoming_earnings', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            ...
            response_type='ApiResponseAllExpectedEarningsDates',  # noqa: E501
    ...
    def expected_earnings_dates_by_company(self, identifier, **kwargs):  # noqa: E501
        """Expected Earnings Dates by Company  # noqa: E501

        Returns expected earnings announcement dates for a company's fiscal periods with confidence intervals and historical filing date ranges.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.expected_earnings_dates_by_company(identifier, _async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.expected_earnings_dates_by_company_with_http_info(identifier, **kwargs)  # noqa: E501
        else:
            (data) = self.expected_earnings_dates_by_company_with_http_info(identifier, **kwargs)  # noqa: E501
            return data

    def expected_earnings_dates_by_company_with_http_info(self, identifier, **kwargs):  # noqa: E501
        """Expected Earnings Dates by Company  # noqa: E501

        Returns expected earnings announcement dates for a company's fiscal periods with confidence intervals and historical filing date ranges.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.expected_earnings_dates_by_company_with_http_info(identifier, _async=True)
        >>> result = thread.get()
        ...
        all_params = ['identifier', 'fiscal_year', 'fiscal_period', 'expected_date_after', 'expected_date_before', 'page_size', 'next_page']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method expected_earnings_dates_by_company" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('identifier' not in params or
            ...
            raise ValueError("Missing the required parameter `identifier` when calling `expected_earnings_dates_by_company`")  # noqa: E501
        ...
        return self.api_client.call_api(
            '/companies/{identifier}/upcoming_earnings', 'GET',
            path_params,
            query_params,
            header_params,
            body=body_params,
            post_params=form_params,
            files=local_var_files,
            response_type='ApiResponseCompanyExpectedEarningsDates',  # noqa: E501
            auth_settings=auth_settings,
            _async=params.get('async'),
            _return_http_data_only=params.get('_return_http_data_only'),
            _preload_content=params.get('_preload_content', True),
    ...
    def get_company_news_body(self, news_story_id, publication_date, **kwargs):  # noqa: E501
        ...
        Returns the body of a news article for moody sources.  This endpoint requires additional authorization beyond basic news access and is for your internal use only - no display. Please see a representative for details.  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
