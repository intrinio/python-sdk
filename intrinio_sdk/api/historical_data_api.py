...
class HistoricalDataApi(object):
    ...
    def get_historical_data(self, identifier, item, **kwargs):  # noqa: E501
        """Get Historical Data  # noqa: E501

        Returns historical values for the given `item` and the entity represented by the given `identifier`  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_historical_data(identifier, item, async=True)
        >>> result = thread.get()
        ...
        if kwargs.get('async'):
            return self.get_historical_data_with_http_info(identifier, item, **kwargs)  # noqa: E501
        else:
            (data) = self.get_historical_data_with_http_info(identifier, item, **kwargs)  # noqa: E501
            return data

    def get_historical_data_with_http_info(self, identifier, item, **kwargs):  # noqa: E501
        """Get Historical Data  # noqa: E501

        Returns historical values for the given `item` and the entity represented by the given `identifier`  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.get_historical_data_with_http_info(identifier, item, async=True)
        >>> result = thread.get()
        ...
        if ('item' not in params or
                params['item'] is None):
            raise ValueError("Missing the required parameter `item` when calling `get_historical_data`")  # noqa: E501
