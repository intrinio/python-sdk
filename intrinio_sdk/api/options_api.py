...
class OptionsApi(object):
    ...
    def get_options_prices_realtime_by_ticker_with_http_info(self, symbol, **kwargs):  # noqa: E501
        ...
        all_params = ['symbol', 'source', 'iv_mode', 'next_page', 'page_size', 'stock_price_source', 'model', 'show_extended_price', 'expiration_start_date', 'expiration_end_date', 'strike']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
    ...
    def options_greeks_by_ticker_identifier_realtime_get(self, identifier, **kwargs):  # noqa: E501
        """Get realtime options greeks by ticker  # noqa: E501

        Retrieves realtime options greeks data for all contracts of a given ticker symbol  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.options_greeks_by_ticker_identifier_realtime_get(identifier, _async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.options_greeks_by_ticker_identifier_realtime_get_with_http_info(identifier, **kwargs)  # noqa: E501
        else:
            (data) = self.options_greeks_by_ticker_identifier_realtime_get_with_http_info(identifier, **kwargs)  # noqa: E501
            return data

    def options_greeks_by_ticker_identifier_realtime_get_with_http_info(self, identifier, **kwargs):  # noqa: E501
        """Get realtime options greeks by ticker  # noqa: E501

        Retrieves realtime options greeks data for all contracts of a given ticker symbol  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.options_greeks_by_ticker_identifier_realtime_get_with_http_info(identifier, _async=True)
        >>> result = thread.get()
        ...
        all_params = ['identifier', 'source', 'model', 'iv_mode', 'stock_price_source', 'expiration_start_date', 'expiration_end_date', 'strike', 'strike_greater_than', 'strike_less_than', 'page_size']  # noqa: E501
        all_params.append('async')
        all_params.append('_return_http_data_only')
        all_params.append('_preload_content')
        all_params.append('_request_timeout')
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method options_greeks_by_ticker_identifier_realtime_get" % key
                )
            params[key] = val
        del params['kwargs']
        # verify the required parameter 'identifier' is set
        if ('identifier' not in params or
                params['identifier'] is None):
            raise ValueError("Missing the required parameter `identifier` when calling `options_greeks_by_ticker_identifier_realtime_get`")  # noqa: E501

        if 'page_size' in params and params['page_size'] > 2500:  # noqa: E501
            raise ValueError("Invalid value for parameter `page_size` when calling `options_greeks_by_ticker_identifier_realtime_get`, must be a value less than or equal to `2500`")  # noqa: E501
        collection_formats = {}
    ...
    def options_greeks_contract_realtime_get(self, contract, **kwargs):  # noqa: E501
        """Get realtime options greeks for a specific contract  # noqa: E501

        Retrieves realtime options greeks data for a specific options contract  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.options_greeks_contract_realtime_get(contract, _async=True)
        >>> result = thread.get()
        ...
        kwargs['_return_http_data_only'] = True
        if kwargs.get('async'):
            return self.options_greeks_contract_realtime_get_with_http_info(contract, **kwargs)  # noqa: E501
        else:
            (data) = self.options_greeks_contract_realtime_get_with_http_info(contract, **kwargs)  # noqa: E501
            return data

    def options_greeks_contract_realtime_get_with_http_info(self, contract, **kwargs):  # noqa: E501
        """Get realtime options greeks for a specific contract  # noqa: E501

        Retrieves realtime options greeks data for a specific options contract  # noqa: E501
        This method makes a synchronous HTTP request by default. To make an
        asynchronous HTTP request, please pass async=True
        >>> thread = api.options_greeks_contract_realtime_get_with_http_info(contract, _async=True)
        >>> result = thread.get()
        ...
        for key, val in six.iteritems(params['kwargs']):
            if key not in all_params:
                raise TypeError(
                    "Got an unexpected keyword argument '%s'"
                    " to method options_greeks_contract_realtime_get" % key
                )
            params[key] = val
        del params['kwargs']
        ...
        if ('contract' not in params or
            ...
            raise ValueError("Missing the required parameter `contract` when calling `options_greeks_contract_realtime_get`")  # noqa: E501
