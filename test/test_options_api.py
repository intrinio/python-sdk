...
class TestOptionsApi(unittest.TestCase):
    ...
    def test_options_greeks_by_ticker_identifier_realtime_get(self):
        """Test case for options_greeks_by_ticker_identifier_realtime_get

        Get realtime options greeks by ticker  # noqa: E501
        """
        pass

    def test_options_greeks_contract_realtime_get(self):
        """Test case for options_greeks_contract_realtime_get
